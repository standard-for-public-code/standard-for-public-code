...
* Codebases SHOULD include a [publiccode.yml](https://github.com/italia/publiccode.yml#the-publiccodeyml-standard/) metadata description so that they're easily discoverable
